...
import src.emulator.kernel as kn
import src.emulator.transformation as tr
...
class GaussianProcess(tr.PreWhiten):
    ...
    def __init__(self, config: ConfigDict, inputs: torch.tensor, outputs: torch.tensor):
    ...
    def optimisation(self, parameters: torch.tensor, niter: int = 10,
                     lrate: float = 0.01, nrestart: int = 5) -> dict:
